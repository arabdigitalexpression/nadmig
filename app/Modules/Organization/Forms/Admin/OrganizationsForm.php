    ...
    public function buildForm()
    {
        $this
            ...
            ->add('governorate', 'choice', [
                ...
                'label' => trans('Organization::dashboard.fields.organization.governorate'),
            ])
            ->add('email', 'email', [
            ...
            $this->add('organization_reservation', 'static', [
                ...
                'value' => trans('Organization::dashboard.fields.organization.organization_reservation')
            ]);
            $this->OptionAndPeriod('min_time_before_usage_to_edit', trans('Organization::dashboard.fields.organization.min_time_before_usage_to_edit'));
           $this
                ->add('change_fees[type]', 'choice', [
                    'choices' => $this->getChangeFeesKeys(),
                    'selected' => $this->change_fees['type'],
                    'label' => trans('Organization::dashboard.fields.organization.change_fees'),
                    'expanded' => true,
            ...
            $this->OptionAndPeriod('min_to_cancel', trans('Organization::dashboard.fields.organization.min_to_cancel'));
            $this
                ->add('cancel_fees[type]', 'choice', [
                    'choices' => $this->getChangeFeesKeys(),
                    'selected' => $this->cancel_fees['type'],
                    'expanded' => true,
                    'label' => trans('Organization::dashboard.fields.organization.cancel_fees'),
            ...
            $this->OptionAndPeriod('max_to_confirm', trans('Organization::dashboard.fields.organization.max_to_confirm'), false, false, true, true);
