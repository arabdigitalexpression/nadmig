        ...
        $(function() {
            ...
            function new_session(data){
                ...
                if(data){
                    ...
                    $newPanel.find(".panel-title").before('<span class="glyphicon glyphicon-remove-circle pull-left "></span>');  
                }
                ...
                $("#space_select_" + hash ).change(function() {
                    getSpaceData($(this).val(), hash, false);
                });
            }
            function getSpaceData(space_id, hash, is_data) {
                var picker = date();
