...
elixir(function(mix) {
    mix
        ...
        .copy(bowerDir + 'chosen/chosen-sprite.png', 'public/build/css/chosen-sprite.png')
        .copy(bowerDir + 'chosen/chosen-sprite@2x.png', 'public/build/css/chosen-sprite@2x.png')
